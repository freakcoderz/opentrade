...
exports.handle = function(app, wss)
{
    ...
    app.get('/agreement', onAgreement);
    app.get('/about', onAbout);
    app.get('/faq', onFAQ);
    app.get('/coins', onCoins);
...
function onAgreement(req, res)
{
    CommonRender(req, res, 'pages/agreement');
}
...
function onFAQ(req, res)
{
    CommonRender(req, res, 'pages/faq');
}

function onCoins(req, res)
{
    CommonRender(req, res, 'pages/coins');
}
